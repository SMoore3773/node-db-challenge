...
- [x] Explain the difference between `Relational Databases` and `SQL`.
      ...
      A relational database is a system of storing related data. A relational database stores data in tabular format where data is grouped in rows and columns. SQL is a structured query language that is used to sort through a database. SQL is optimized for querying and retrieving data.

- [x] Why do tables need a `primary key`?

      A primary key is used to identify each unique entry in a row inside of a table.

- [x] What is the name given to a table column that references the primary key on another table.

      A column that references a primary key in a another table is a foreign key.

- [x] What do we need in order to have a _many to many_ relationship between two tables.

      We need a bridge table to organize a many-to-many relationship.
